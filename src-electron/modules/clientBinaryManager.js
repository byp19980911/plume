...
const BINARY_URL = 'https://gitee.com/byp19980911/plume/raw/master/clientBinaries.json'
    ...
    return got(BINARY_URL, {
      ...
      .then(localConfig => {
        ...
        return mgr
          .init({
            folders: [
              path.join(Settings.userDataPath, 'binaries', 'plume', 'unpacked')
            ]
          })
          .then(() => {
          ...
          dialog.showMessageBox(
            {
              type: 'warning',
              buttons: ['OK'],
              message: global.i18n.t('plume.errors.nodeChecksumMismatch.title'),
              detail: global.i18n.t(
                'plume.errors.nodeChecksumMismatch.description',
                {
                  type: nodeInfo.type,
