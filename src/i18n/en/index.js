export default {
  ...
  nav: {
    ...
    contract: {
      deploy: {
        ...
        sublabel: 'Deploy contract to Proton'
      },
      my: {
        label: 'My Contracts',
        sublabel: 'Manage contracts on Proton',
        view: 'Detail',
        add: 'Add Contract'
      }
    }
  ...
  splash: {
    downloading: {
      title: 'Plume is initializing ...'
    },
    syncing: {
      title: 'Plume is syncing chaindata ...'
    }
  },
  contract: {
    add: {
      description: 'Add contracts that already deployed to Proton to "My Contracts" ',
      name: {
        label: 'Name',
